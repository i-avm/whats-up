...
<section bind:this={section}>
	...
	>
		<div class="flex flex-col justify-between">
			<div>
				<h2 class="text-4xl lg:text-5xl font-bold leading-tight">WhatsUp!</h2>
			...
			<div class="mt-8 text-center">
				...
				>
					...
					<ellipse cx="548" cy="493.13" rx="548" ry="8.86" fill="#25D366" opacity="0.1" />
					<ellipse cx="548" cy="565.88" rx="548" ry="8.86" fill="#25D366" opacity="0.1" />
					<ellipse cx="548" cy="341.3" rx="548" ry="8.86" fill="#25D366" opacity="0.1" />
					<ellipse cx="548" cy="417.21" rx="548" ry="8.86" fill="#25D366" opacity="0.1" />
					<path
